...
<head>
    ...
    <title>CyberSecutrity | Inicio</title>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box text-center">
                            <h3 class="box-title"><img src="../plugins/images/cybersecurity.png" width="300" alt="homepage" /></h3>
                            <img src="../plugins/images/seguridad_fondo.jpg" width="900">
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
