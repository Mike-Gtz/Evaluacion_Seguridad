...
<head>
    ...
    <title>CyberSecurity | Recuperar Cuenta</title>
            ...
            <div  style="background-color: #000">
                <div class="row align-items-center" style="background-color: #000">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color: #000">
                        <br><br>
                        <h4 class="page-title text-center text-white" style="background-color: #000">Crear Nueva Contraseña</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="car-body">
                            <form class="form-horizontal form-material" method="post" action="BD/recuperar.php">
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0"><h5>Ingresar su Correo con el que se dió de alta</h5></label>
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0"> Ingrese su Nueva Contraseña</label>
                                        <div class="col-md-12 border-bottom p-0">
